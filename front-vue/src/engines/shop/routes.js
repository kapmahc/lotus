...
import PostalCodeIndex from './postal-codes/Index'

export default [
  {name: 'shop.postal-codes.index', path: '/shop/postal-codes', component: PostalCodeIndex},

  {name: 'shop.currencies.edit', path: '/shop/currencies/:id/edit', component: CurrenciesEdit},
